...
```bash
$ cp -a $GOPATH/src/github.com/nailabx/velero-image-update/* $GOPATH/src/github.com/someuser/velero-plugins/.
```
...
[1]: https://github.com/nailabx/velero-image-update/workflows/Continuous%20Integration/badge.svg
